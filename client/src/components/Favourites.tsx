...
function Favourites() {
    ...
    return (
        <div className={"flex flex-col w-[30%] h-full max-h-[95%] justify-around bg-zinc-800 border border-white/5 items-center rounded-2xl m-4 mt-0 transition duration-75"} >
