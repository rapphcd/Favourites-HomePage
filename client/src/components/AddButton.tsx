    ...
    return (
        <div>
            ...
            <div className={" flex items-center justify-center"}>
                <div
                    className={"w-[20%] bg-zinc-900 hover:bg-zinc-950/60 rounded-full flex items-center justify-center overflow-hidden p-2 cursor-default transition select-none"}
                    onClick={() => {
                        setVisibility(true)
                    }}>
                    <CirclePlus/>
